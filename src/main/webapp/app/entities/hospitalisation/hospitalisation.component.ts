...
export class HospitalisationComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.hospitalisationService
            ...
            .subscribe(
                (res: HttpResponse<IHospitalisation[]>) => this.paginateHospitalisations(res.body, res.headers),
    ...
    trackId(index: number, item: IHospitalisation) {
        return item.id;
    }

    registerChangeInHospitalisations() {
        this.eventSubscriber = this.eventManager.subscribe('hospitalisationListModification', response => this.reset());
    }
    ...
    private paginateHospitalisations(data: IHospitalisation[], headers: HttpHeaders) {
