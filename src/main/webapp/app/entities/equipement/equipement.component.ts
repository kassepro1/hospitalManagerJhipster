...
export class EquipementComponent implements OnInit, OnDestroy {
    ...
    loadAll() {
        this.equipementService
            ...
            .subscribe(
                (res: HttpResponse<IEquipement[]>) => this.paginateEquipements(res.body, res.headers),
    ...
    registerChangeInEquipements() {
        this.eventSubscriber = this.eventManager.subscribe('equipementListModification', response => this.reset());
    }
    ...
    private paginateEquipements(data: IEquipement[], headers: HttpHeaders) {
        this.links = this.parseLinks.parse(headers.get('link'));
        this.totalItems = parseInt(headers.get('X-Total-Count'), 10);
        for (let i = 0; i < data.length; i++) {
            this.equipements.push(data[i]);
        }
    }
