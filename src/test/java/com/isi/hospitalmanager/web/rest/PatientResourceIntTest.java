...
public class PatientResourceIntTest {
    ...
    private static final String DEFAULT_NUM_PATIENT = "AAAAAAAAAA";
    private static final String UPDATED_NUM_PATIENT = "BBBBBBBBBB";
    ...
    private static final LocalDate DEFAULT_DATENAISS = LocalDate.ofEpochDay(0L);
    private static final LocalDate UPDATED_DATENAISS = LocalDate.now(ZoneId.systemDefault());
    ...
    public static Patient createEntity(EntityManager em) {
        Patient patient = new Patient()
            .numPatient(DEFAULT_NUM_PATIENT)
            .prenom(DEFAULT_PRENOM)
            .nom(DEFAULT_NOM)
            .tel(DEFAULT_TEL)
            .adresse(DEFAULT_ADRESSE)
            .email(DEFAULT_EMAIL)
            .datenaiss(DEFAULT_DATENAISS);
        return patient;
    }
    ...
    public void createPatient() throws Exception {
        ...
        assertThat(testPatient.getNumPatient()).isEqualTo(DEFAULT_NUM_PATIENT);
        ...
        assertThat(testPatient.getDatenaiss()).isEqualTo(DEFAULT_DATENAISS);
    }
    ...
    @Test
    @Transactional
    public void checkNumPatientIsRequired() throws Exception {
        int databaseSizeBeforeTest = patientRepository.findAll().size();
        // set the field null
        patient.setNumPatient(null);
    ...
    public void getAllPatients() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients?sort=id,desc"))
            ...
            .andExpect(jsonPath("$.[*].numPatient").value(hasItem(DEFAULT_NUM_PATIENT.toString())))
    ...
    public void getPatient() throws Exception {
        ...
        restPatientMockMvc.perform(get("/api/patients/{id}", patient.getId()))
            ...
            .andExpect(jsonPath("$.numPatient").value(DEFAULT_NUM_PATIENT.toString()))
    ...
    public void updatePatient() throws Exception {
        ...
        updatedPatient
            .numPatient(UPDATED_NUM_PATIENT)
            .prenom(UPDATED_PRENOM)
            .nom(UPDATED_NOM)
            .tel(UPDATED_TEL)
            .adresse(UPDATED_ADRESSE)
            .email(UPDATED_EMAIL)
            .datenaiss(UPDATED_DATENAISS);
        ...
        Patient testPatient = patientList.get(patientList.size() - 1);
        assertThat(testPatient.getNumPatient()).isEqualTo(UPDATED_NUM_PATIENT);
        ...
        assertThat(testPatient.getDatenaiss()).isEqualTo(UPDATED_DATENAISS);
    }
