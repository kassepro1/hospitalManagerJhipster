...
describe('Service Tests', () => {
    describe('Traitement Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Traitement(0, currentDate, 'AAAAAAA', 'AAAAAAA', 'AAAAAAA');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a Traitement', async () => {
                const returnedFromService = Object.assign(
                    {
                        id: 0,
                        date: currentDate.format(DATE_FORMAT)
            ...
            it('should return a list of Traitement', async () => {
                const returnedFromService = Object.assign(
                    {
                        date: currentDate.format(DATE_FORMAT),
                        observation: 'BBBBBB',
