...
import { LitComponent } from 'app/entities/lit/lit.component';
import { LitService } from 'app/entities/lit/lit.service';
import { Lit } from 'app/shared/model/lit.model';

describe('Component Tests', () => {
    describe('Lit Management Component', () => {
        let comp: LitComponent;
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.lits[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
