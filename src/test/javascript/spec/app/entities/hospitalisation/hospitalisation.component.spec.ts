...
import { HospitalisationComponent } from 'app/entities/hospitalisation/hospitalisation.component';
...
describe('Component Tests', () => {
    describe('Hospitalisation Management Component', () => {
        let comp: HospitalisationComponent;
        ...
        beforeEach(() => {
            TestBed.configureTestingModule({
                ...
                .overrideTemplate(HospitalisationComponent, '')
                .compileComponents();
        ...
        it('Should call load all on init', () => {
            ...
            expect(comp.hospitalisations[0]).toEqual(jasmine.objectContaining({ id: 123 }));
        });
